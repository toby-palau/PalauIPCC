    ...
    return (
        <div className="bg-black min-h-screen md:p-16 p-0">
            ...
            <div className="flex flex-row items-end justify-end md:px-0 px-5 md:py-0 py-5">
                ...
                <p className={`${dmsans.className} w-64 text-xs text-white text-right`}>
                    The content of this experience was generated based on the <Link href="https://www.ipcc.ch/report/sixth-assessment-report-cycle/" className={"text-blue hover:text-blue-dark underline"} target="_blank">2023 IPCC Synthesis Report</Link>.
                </p>
            </div>
        </div>
    )
