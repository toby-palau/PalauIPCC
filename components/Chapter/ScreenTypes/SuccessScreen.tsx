...
export const SuccessScreen = ({title, subtitle, avatarImage}: SuccessProps) => {
    ...
    return (
        <div className="absolute min-h-full w-full flex flex-col justify-center items-center p-10 pointer-events-none">
            ...
            <h2 className={`${rocksalt.className} md:text-6xl text-2xl text-green ${startAnimations ? "-rotate-6 scale-100 opacity-100" : "-rotate-12 scale-150 opacity-20"} md:-mt-6 -mt-4 mb-4 transition duration-1000`}>{subtitle}</h2>
            <img 
