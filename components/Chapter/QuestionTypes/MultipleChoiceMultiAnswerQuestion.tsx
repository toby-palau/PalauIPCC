        ...
        <div className="max-w-xl m-auto flex-col items-center justify-between py-6 px-6 border-2 border-white rounded bg-black">
            ...
            <div className="flex flex-col items-center justify-between">
                { props.question.options.map(o => {
                    ...
                    let className = `w-full flex flex-row justify-between items-center cursor-pointer sm:text-xl text-md text-center text-black rounded-md my-0.5 p-3 ${!props.disabled && "active:scale-95"} transition-all duration-100`;
            ...
            <button 
                className={`mt-2 p-4 w-full rounded-md bg-blue hover:bg-blue-dark active:scale-95 transition-all duration-100`} 
